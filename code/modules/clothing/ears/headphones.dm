/obj/item/clothing/ears/headphones
	...
	// MISSING SPRITE icon = 'modular_pariah/master_files/icons/obj/clothing/accessories.dmi'
	worn_icon = 'modular_pariah/master_files/icons/mob/clothing/ears.dmi' // MIGRATE ICON
